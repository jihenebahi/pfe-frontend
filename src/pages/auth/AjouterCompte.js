...
const AjouterCompte = () => {
  ...
  const validateForm = () => {
    ...
    setErrors(newErrors);
    setFormValid(
      prenomValidation.isValid && nomValidation.isValid && emailValidation.isValid &&
      phoneValidation.isValid  && roleValidation.isValid && passwordValidation.isValid &&
  ...
  const handleRadioChange = (value) => setFormData(prev => ({ ...prev, statut: value }));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await createUser({
        first_name: formData.prenom, last_name: formData.nom,
        email: formData.email, phone: formData.telephone,
        role: formData.role, is_active: formData.statut === 'actif', password: formData.password,
      });
      if (result.success) navigate('/gestion-comptes', { state: { message: result.message || 'Compte créé avec succès !' } });
    } catch (err) {
  ...
  return (
    <Layout>
      {/* ── Tout le contenu est centré dans page-wrapper ── */}
      <div className="page-wrapper">
        ...
        <div className="form-card">
          ...
          <form onSubmit={handleSubmit} className="form-body">
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="text" id="prenom" name="prenom" placeholder="Ex : Karima"
                  ...
                  className={errors.prenom && touched.prenom ? 'error' : ''} required />
              ...
              <div className="form-group">
                ...
                <input type="text" id="nom" name="nom" placeholder="Ex : Benali"
                  ...
                  className={errors.nom && touched.nom ? 'error' : ''} required />
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="email" id="email" name="email" placeholder="Ex : k.benali@centre.tn"
                  ...
                  className={errors.email && touched.email ? 'error' : ''} required />
              ...
              <div className="form-group">
                ...
                <input type="tel" id="telephone" name="telephone" placeholder="Ex : +216 55 123 456"
                  ...
                  className={errors.telephone && touched.telephone ? 'error' : ''} required />
              ...
              <div className="form-group full-width">
                ...
                <div className="select-wrapper">
                  <select id="role" name="role" value={formData.role}
                    ...
                    className={errors.role && touched.role ? 'error' : ''} required>
            ...
            <div className="form-row">
              <div className="form-group">
                <label htmlFor="password"><i className="fa-solid fa-lock"></i> Mot de passe <span className="required">*</span></label>
                <div className="input-password">
                  ...
                  <button type="button" className="toggle-pwd" onClick={() => togglePasswordVisibility('password')} tabIndex="-1">
              ...
              <div className="form-group">
                <label htmlFor="password_confirm"><i className="fa-solid fa-lock"></i> Confirmer le mot de passe <span className="required">*</span></label>
                <div className="input-password">
                  <input type={showPassword.confirm ? 'text' : 'password'} id="password_confirm" name="password_confirm"
                    placeholder="Répétez le mot de passe" value={formData.password_confirm}
                    onChange={handleChange} onBlur={() => handleBlur('password_confirm')}
                    className={errors.password_confirm && touched.password_confirm ? 'error' : ''} required />
                  <button type="button" className="toggle-pwd" onClick={() => togglePasswordVisibility('confirm')} tabIndex="-1">
